...
import com.example.app_sample.databinding.ActivityMain2Binding;
...
public class MainActivity2 extends AppCompatActivity {
        ...
        send_otp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(number.getText().toString())){
                    Toast.makeText(MainActivity2.this, "Please Enter valid phone no", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    protected void onStart() {
        ...
        if (account!=null){
            Toast.makeText(MainActivity2.this, "User already Signed-in", Toast.LENGTH_SHORT).show();
            Intent intent=new Intent(getApplicationContext(),MainActivity.class);
            startActivity(intent);
        }
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationCompleted(@NonNull PhoneAuthCredential phoneAuthCredential) {
            ...
            if (code!=null){
                ...
                Toast.makeText(MainActivity2.this, "Code is " +code, Toast.LENGTH_SHORT).show();
